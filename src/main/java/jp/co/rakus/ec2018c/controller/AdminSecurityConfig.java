...
public class AdminSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http	
				...
				.antMatchers("/admin/index").permitAll() // 「/」などのパスはすべてのユーザーに許可
...
//				.failureUrl("admin/index?error=true") 		// ログイン失敗に遷移させるパス
//				.defaultSuccessUrl("/admin/top", true) // 第1引数：デフォルトでログイン成功時に遷移させるパス
...
//	@Autowired
//	public void configureGLobal(AuthenticationManagerBuilder auth) throws Exeption {
//		
////		auth
