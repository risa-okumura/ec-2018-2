		...
		<nav class="navbar navbar-default">
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="${pageContext.request.contextPath}/viewItemList/indexTest"> <!-- 企業ロゴ --> <img
...
<!-- 								<button type="reset" value="クリア" class="btn btn-default">クリア</button> -->
		...
		<form:form action="${pageContext.request.contextPath}/viewItemList/indexTest" method="post">
		<input type="hidden" name="pageNumber" value="${pageNum}"/>
		<button type="submit" value="pageNumber"><c:out value="${pageNum}"/></button>
		</form:form>
		</c:forEach>
